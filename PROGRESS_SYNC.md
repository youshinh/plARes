...
| ---------- | -------- | ------ | ------------------------------- | ------ | ----------------------------------------------------------------------------------------------- | ------- |
| 2026-03-12 | Codex    | T1-42  | /frontend/src, /scripts          | DONE   | Character display fix: resolveLegacyAssetSlot mapping for Type K (medium) and E2E script port/module fix | なし    |
