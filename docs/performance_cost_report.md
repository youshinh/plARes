...
| ----------------------- | ---------------------- | ------------------- | ------------------- | -------------- | ------ |
| 実況生成 (Live)         | gemini-3-flash-preview | ~2,000              | ~200                | < 500ms        | TBD    |
| キャラクター生成        | gemini-2.0-flash       | ~1,500              | ~200                | < 3s           | TBD    |
| 音声判定 (Voice Judge)  | gemini-3-flash-preview | ~500                | ~50                 | < 1s           | TBD    |
| Context Cache 作成      | gemini-3-flash-preview | ~32,000             | 0                   | < 5s           | TBD    |
| テクスチャ融合 (Imagen) | imagen-exp             | ~100 + image        | 1 image             | < 2s           | TBD    |
| 勝利BGM (Lyria)         | lyria-002              | ~200                | audio               | < 10s          | TBD    |
