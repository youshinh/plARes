...
import {
  resolveConfiguredLivePolicyPhase,
  useLiveRouteSelector,
} from "./hooks/useLiveRouteSelector";
import {
  useEntryScreenProps,
  useMainHudProps,
} from "./hooks/useAppOverlayProps";
...
const defaultBackendProtocol =
  window.location.protocol === "https:" ? "wss" : "ws";
const WS_URL =
  import.meta.env.VITE_WS_URL ??
  `${defaultBackendProtocol}://${defaultBackendHost}:8000/ws/game`;
...
const UI_TEXT: Record<UiLang, Record<string, string>> = {
  ja: {
    ...
    arUnavailable: "AR非対応",
    arUnsupportedHint:
      "この端末ではWebXR ARが使えません。通常表示モードでご利用ください。",
    endMatch: "試合終了",
    ...
    flowHubTitle: "フローハブ",
    flowHubDesc:
      "バトルへ急がず、育成と共創の流れに沿って次の行動を選びましょう。",
    ...
    languageSettingHint:
      "あとで言語を変えたい時は、ここからいつでも切り替えられます。",
    languageChangeAfterMatch:
      "対戦中は言語を変更できません。ハブに戻ってから変更してください。",
    debugSection: "Live / Debug",
    debugBattleState: "戦況スナップショット",
    debugAdkTactic: "ADK戦術提案",
    routeGuideTitle: "初回おすすめルート",
    routeGuideDesc:
      "散歩 → 修行 → 対戦 の順で進むと、機体の理解とシンクロが安定します。",
    ...
    routeGuideDoneDesc:
      "初回おすすめルートは達成済みです。必要な時だけ詳細を開けます。",
    ...
    prepBodyHeavy: "ヘビー",
    prepBodyMedium: "ミディアム",
    prepBodySlim: "スリム",
    prepBodyHeavyDesc: "重装甲でパワー寄り",
    prepBodyMediumDesc: "バランスの取れた標準フレーム",
    ...
    walkFocusDesc:
      "散歩中は探索と会話が主役です。クラフトか観察トリガーを使い、終わったら散歩を完了します。",
    trainingFocusTitle: "詠唱と反射を整える",
    trainingFocusDesc:
      "修行では詠唱精度を上げます。EX が溜まったら必殺詠唱を試し、終わったら修行を完了します。",
    matchFocusTitle: "対戦中の主行動",
    matchFocusDesc:
      "対戦では位置合わせと必殺のタイミングだけに集中します。育成系の操作はここでは出しません。",
    ...
    fusionSuccess: "融合完了",
    fusionSuccessBody:
      "新しい素材を機体へ取り込みました。散歩を続けるか、完了して次へ進めます。",
    fusionRetry: "再試行",
    fusionRetake: "撮り直す",
    fusionClose: "散歩に戻る",
    ...
    scanEquipmentPromptPlaceholder:
      "例: 春巻きソード / 額バイザー / バックパック",
  ...
  en: {
    ...
    chooseLanguageDesc:
      "Pick your default UI language. You can change this later.",
    scanTitle: "⚙️ Create Your Plareser",
    scanCameraDesc:
      "Capture your face with the front camera to generate a one-of-a-kind AI robot.",
    ...
    scanCameraDenied:
      "Camera access was not granted. Use the skip route instead.",
    scanTextareaPlaceholder:
      "e.g. A silent heavy robot with patience and strong armor",
    scanFallbackPrompt: "A balanced all-round robot",
    scanPresetSpeedLabel: "⚡ Speed Ninja",
    scanPresetSpeedPrompt:
      "A sharp-eyed ninja robot built for speed and agility",
    scanPresetPowerLabel: "💪 Power Brawler",
    scanPresetPowerPrompt:
      "A sturdy, muscular robot with overwhelming power and toughness",
    scanPresetCharmLabel: "🎤 Idol Charmer",
    scanPresetCharmPrompt:
      "A cheerful idol robot with expressive emotions and crowd appeal",
    summonTitle: "Phase 1.3: First Summoning",
    summonDesc:
      "Scan a real floor or table surface to position and summon your AI partner.",
    ...
    arUnsupportedHint:
      "WebXR AR is not available on this device. Continue in standard view mode.",
    endMatch: "End Match",
    ...
    memoryUnreadable:
      "Memory is being organized. Showing recent readable events only.",
    ...
    alignNeedSurface:
      "No AR surface detected yet. Point the camera at the floor and retry.",
    ...
    flowHubDesc:
      "Choose the next step in the intended loop instead of jumping straight into battle.",
    flowPhase1Done: "Phase 1 complete: first summon finished",
    flowPhase2Title: "Phase 2: Daily Co-creation",
    flowPhase2Desc:
      "Use Walk for environment bonding or Training for incantation accuracy.",
    flowPhase3Title: "Phase 3: Battle",
    flowPhase3Desc:
      "Start a match after alignment. Local reflexes + AI tactical overrides.",
    ...
    settingsDesc:
      "Use this area for language changes and secondary menu controls.",
    ...
    languageSettingHint:
      "You can come back here later whenever you want to change the UI language.",
    languageChangeAfterMatch:
      "Language changes are locked during a match. Return to the hub first.",
    debugSection: "Live / Debug",
    debugBattleState: "Battle Snapshot",
    debugAdkTactic: "ADK Tactic",
    routeGuideTitle: "Recommended First Route",
    routeGuideDesc:
      "Follow Walk → Training → Battle once to build stable sync and context.",
    ...
    routeGuideDoneDesc:
      "The recommended first route is complete. Open the details only when you need them.",
    ...
    prepBodyHeavy: "Heavy",
    prepBodyMedium: "Medium",
    prepBodySlim: "Slim",
    prepBodyHeavyDesc: "Power-focused heavy frame",
    prepBodyMediumDesc: "Balanced standard frame",
    ...
    walkFocusDesc:
      "Walk mode is for exploration and ambient dialogue. Trigger craft or observation, then wrap the walk when you are done.",
    trainingFocusTitle: "Sharpen incantation and reflexes",
    trainingFocusDesc:
      "Training is for sync and articulation. Build EX, test the incantation, then finish the session.",
    matchFocusTitle: "Match control focus",
    matchFocusDesc:
      "In battle, focus on alignment, dodges, and special timing. Growth actions should stay out of this screen.",
    fusionTitle: "Real-World Fusion Craft",
    fusionHint:
    ...
    fusionSuccessBody:
      "The new material has been synced to your machine. Continue the walk or finish it and move on.",
    fusionRetry: "Retry",
    fusionRetake: "Retake",
    ...
    scanEquipmentPromptPlaceholder:
      "e.g. Spring-roll sword / Visor crest / Jet backpack",
  ...
  es: {
    ...
    chooseLanguageDesc:
      "Selecciona el idioma inicial de la interfaz. Puedes cambiarlo despues.",
    scanTitle: "⚙️ Crear tu Plareser",
    scanCameraDesc:
      "Captura tu rostro con la camara frontal para generar un robot AI unico.",
    ...
    scanCameraDenied:
      "No se concedio acceso a la camara. Usa la ruta de salto.",
    ...
    summonDesc:
      "Escanea el suelo o una mesa real para colocar e invocar a tu companero AI.",
    ...
    arUnsupportedHint:
      "WebXR AR no esta disponible en este dispositivo. Usa el modo de vista normal.",
    endMatch: "Finalizar",
    ...
    memoryUnreadable:
      "La memoria se esta ordenando. Solo se muestran eventos legibles.",
    ...
    alignNeedSurface:
      "Aun no se detecta una superficie AR. Enfoca el suelo y reintenta.",
    ...
    flowHubDesc:
      "Elige el siguiente paso del bucle de juego en lugar de entrar directo al combate.",
    flowPhase1Done: "Fase 1 completa: primera invocacion finalizada",
    flowPhase2Title: "Fase 2: Co-creacion diaria",
    flowPhase2Desc:
      "Paseo para contexto ambiental o Entreno para mejorar la invocacion.",
    flowPhase3Title: "Fase 3: Batalla",
    flowPhase3Desc:
      "Inicia combate despues de alinear arena. Reflejos locales + tactica AI.",
    ...
    settingsDesc:
      "Usa esta zona para cambiar idioma y otras opciones secundarias.",
    ...
    languageSettingHint:
      "Puedes volver aqui mas tarde para cambiar el idioma cuando quieras.",
    languageChangeAfterMatch:
      "No puedes cambiar el idioma durante una batalla. Vuelve al hub primero.",
    debugSection: "Live / Debug",
    debugBattleState: "Estado de batalla",
    debugAdkTactic: "Tactica ADK",
    routeGuideTitle: "Ruta inicial recomendada",
    routeGuideDesc:
      "Sigue Paseo → Entreno → Batalla una vez para mejorar sincronia y contexto.",
    ...
    routeGuideDoneDesc:
      "La ruta inicial recomendada ya esta completada. Abre el detalle solo cuando lo necesites.",
    routeOpenCompleted: "Abrir detalle",
    routeHideCompleted: "Cerrar",
    prepTitle: "Briefing previo a batalla",
    prepDesc:
      "Revisa progreso de ruta y configuracion del robot antes de combatir.",
    ...
    prepBodyMedium: "Medio",
    prepBodySlim: "Ligero",
    prepBodyHeavyDesc: "Armazon pesado orientado a potencia",
    prepBodyMediumDesc: "Armazon estandar balanceado",
    ...
    walkFocusDesc:
      "El paseo sirve para explorar y conversar. Activa craft u observacion y termina el paseo cuando acabes.",
    trainingFocusTitle: "Afina el canto y los reflejos",
    trainingFocusDesc:
      "El entrenamiento mejora la sincronizacion. Llena EX, prueba la invocacion y termina la sesion al acabar.",
    matchFocusTitle: "Foco principal del combate",
    matchFocusDesc:
      "Durante la batalla concentrate en alineacion, esquiva y especial. Las acciones de crecimiento no deben invadir esta pantalla.",
    fusionTitle: "Real-World Fusion Craft",
    fusionHint:
    ...
    fusionSuccessBody:
      "El nuevo material ya se sincronizo con tu maquina. Sigue el paseo o terminalo para avanzar.",
    ...
    scanEquipmentPromptPlaceholder:
      "ej. Espada de rollito / Visor frontal / Mochila propulsora",
...
function App() {
  ...
  const [dynamicTranslations, setDynamicTranslations] = useState<Record<
    string,
    string
  > | null>(() => loadCachedTranslations(initialSelectedLanguage));
  ...
  const t = dynamicTranslations
    ...
    : UI_TEXT[uiLang];
  const { isSetupDone, isGenerating, generateCharacter, resetSetup } =
    useCharacterSetup();
  ...
  const activeRemotePeerId = useArenaSyncStore((s) => s.activeRemotePeerId);
  ...
  const [trainingSession, setTrainingSession] = useState<ModeSession | null>(
    null,
  );
  ...
  const liveRouteSelector = useLiveRouteSelector(
    resolveConfiguredLivePolicyPhase(),
  );
  ...
  const walkProgress = Math.max(
    profileView.totalWalkSessions,
    localRouteProgress.walk,
  );
  const trainingProgress = Math.max(
    profileView.totalTrainingSessions,
    localRouteProgress.training,
  );
  const battleProgress = Math.max(
    profileView.totalMatches,
    localRouteProgress.battle,
  );
  ...
  const queuePendingTranslation = (langCode: string) => {
    try {
      localStorage.setItem(
        STORAGE_PENDING_TRANSLATION_KEY,
        canonicalizeLocale(langCode),
      );
    } catch {
      // noop
    }
  ...
  const clearPendingTranslation = (langCode?: string) => {
    try {
      ...
      if (
        !langCode ||
        canonicalizeLocale(pending) === canonicalizeLocale(langCode)
      ) {
  ...
  const requestUiTranslations = (langCode: string) => {
    ...
    wsService.sendEvent({
      ...
      payload: {
        lang: canonical,
        base_keys: baseDict as unknown as Record<string, string>,
      },
    });
    window.dispatchEvent(
      new CustomEvent("show_subtitle", {
  ...
  const requestPendingTranslationIfNeeded = () => {
    ...
    try {
      pendingLocale =
        localStorage.getItem(STORAGE_PENDING_TRANSLATION_KEY) || "";
    } catch {
      pendingLocale = "";
    }
    const canonical = canonicalizeLocale(
      pendingLocale || selectedLanguage,
      selectedLanguage,
    );
    if (
      localeUsesBuiltinDictionary(canonical) ||
      loadCachedTranslations(canonical)
    ) {
  ...
  const applyLanguage = (langCode: string, markAsChosen: boolean) => {
    ...
    try {
      ...
      console.info(
        `[App] Language applied: ${canonical} (chosen: ${markAsChosen})`,
      );
    } catch (err) {
    ...
    console.info(
      `[App] Checking translation for ${canonical} - BuiltIn: ${hasBuiltIn}, Cached: ${!!existingCache}`,
    );
  ...
  useEffect(() => {
    ...
    window.addEventListener(
      "plares_ws_status",
      onSocketStatus as EventListener,
    );
    return () => {
  ...
  useEffect(() => {
    try {
      localStorage.setItem(
        STORAGE_ROUTE_PROGRESS_KEY,
        JSON.stringify(localRouteProgress),
      );
    } catch {
      // noop
    }
    ...
    wsService.sendEvent({
      ...
      payload: {
        ...
        accuracyScore: Number(
          Math.min(1, Math.max(0, battleState.exGauge / EX_GAUGE.MAX)).toFixed(
            3,
          ),
        ),
        speedScore: Number(
          Math.min(1, Math.max(0, profileView.syncRate)).toFixed(3),
        ),
  ...
  const submitFusionCraftRequest = (payload: {
    ...
    setFusionCraftFlow({
      ...
      concept: payload.concept,
      message:
        payload.craftKind === "attachment"
          ? t.scanEquipmentGenerating
          : t.fusionGenerating,
      textureUrl: "",
      craftKind: payload.craftKind,
      mountPoint: payload.mountPoint,
  ...
  const requestMatchEnd = () => {
    const localBattleHp = isSolo ? localHp : battleState.hp;
    const remoteBattleHp = isSolo ? enemyHp : battleState.opponentHp;
    const remoteMatchId = activeRemotePeerId || "cpu_rival";
    const localAhead = localBattleHp >= remoteBattleHp;
    ...
    wsService.sendEvent({
      ...
      payload: {
        trigger: "manual",
        winner: localAhead ? PLAYER_ID : remoteMatchId,
        loser: localAhead ? remoteMatchId : PLAYER_ID,
        loser_lang: localAhead ? selectedLanguage : PLAYER_LANG,
      },
    });
    setIsBattlePrepOpen(false);
    setShowFusionCraft(false);
  ...
  useBgmAudio(bgmUrl, bgmFallbackCue);
  ...
  const entryScreensProps = useEntryScreenProps({
    ...
    languagePresets,
    selectedLanguage,
    applyLanguage: (langCode, persistSelection = false) =>
      applyLanguage(langCode, persistSelection),
    setSelectedLanguage,
  ...
  const mainHudProps = useMainHudProps({
    ...
    onToggleLiveConnection: isLiveConnected
      ? disconnectLiveDirect
      : connectLiveDirect,
    ...
    onWalkVisionOrProfileSync:
      playMode === "walk" ? sendWalkVisionTrigger : requestProfileSync,
