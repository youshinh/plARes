...
2. **Lyria Victory Music**:
   - On match win, analyze the `aiMemorySummary` to generate a comedic or epic prompt. Trigger Lyria API asynchronously and send the MP3 URL to the frontend for the victory screen.
